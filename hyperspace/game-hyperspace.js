...
import { HSGameStateDef, registerGameStateSystems, } from "./hyperspace-gamestate.js";
import { createGridComposePipelines } from "../render/pipelines/std-compose.js";
import { noisePipes } from "../render/pipelines/std-noise.js";
import { DevConsoleDef } from "../debug/console.js";
import { initOcean, OceanDef, oceanJfa, UVPosDef, registerOceanUVFns, } from "../ocean/ocean.js";
import { vec2, vec3, V } from "../matrix/sprig-matrix.js";
import { createSpawner, registerUvSpawnSystems, } from "./uv-spawner.js";
import { tempVec3 } from "../matrix/temp-pool.js";
import { createDarkStarNow, registerDarkstarSystems, STAR1_COLOR, STAR2_COLOR, } from "./darkstar.js";
...
export async function initHyperspaceGame() {
    ...
    EM.addSystem("hyperspaceGame", Phase.GAME_WORLD, null, [RendererDef, DevConsoleDef], (_, res) => {
