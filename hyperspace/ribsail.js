...
import { signedAreaOfTriangle, positionAndTargetToOrthoViewProjMatrix, } from "../utils/utils-3d.js";
...
export const { RibSailPropsDef, RibSailLocalDef, createRibSailNow } = defineNetEntityHelper({
    name: "ribSail",
    defaultProps: () => ({
    // pitch: Math.PI / 2,
    }),
...
export function registerRibSailSystems() {
    EM.addSystem(`updateRibSail`, Phase.GAME_WORLD, [RibSailLocalDef, RenderableDef], [RendererDef], (cs, res) => {
        for (let sail of cs) {
