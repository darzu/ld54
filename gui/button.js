...
f 7// 8// 3// 2//
`;
export const ButtonDef = EM.defineNonupdatableComponent("button", (key, data, colors) => ({
    key,
...
export const ButtonsStateDef = EM.defineResource("buttonsState", (gmesh) => ({
...
function initButtonGUI(res) {
    ...
    EM.addSystem("buttonStateUpdate", Phase.READ_INPUTS, [ButtonDef], [PhysicsResultsDef, ButtonsStateDef, InputsDef, UICursorDef], (es, res) => {
        // reset by-key state
    ...
    EM.addSystem("buttonColors", Phase.GAME_WORLD, [ButtonDef, ColorDef], [ButtonsStateDef], (es, res) => {
        for (let btn of es) {
