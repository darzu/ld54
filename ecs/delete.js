...
export const OnDeleteDef = EM.defineNonupdatableComponent("onDelete", (onDelete) => onDelete);
...
if (WARN_DEAD_CLEANUP) {
    EM.addSystem("deadCleanupWarning", Phase.POST_GAME_WORLD, [DeadDef], [], (entities) => {
