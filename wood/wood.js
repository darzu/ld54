...
import { getQuadMeshEdges, meshStats, normalizeMesh, } from "../meshes/mesh.js";
import { RenderableConstructDef, RenderableDef, RendererDef, } from "../render/renderer-ecs.js";
import { tempVec3 } from "../matrix/temp-pool.js";
import { assert, assertDbg, createIntervalTracker, dbgOnce, } from "../utils/util.js";
import { range } from "../utils/util.js";
import { centroid, quatFromUpForward, randNormalVec3, } from "../utils/utils-3d.js";
import { SplinterPoolsDef } from "./wood-splinters.js";
...
export const WoodStateDef = EM.defineNonupdatableComponent("woodState", (s) => {
    return s;
});
export const WoodAssetsDef = EM.defineResource("woodAssets", (registry = {}) => registry);
export const WoodHealthDef = EM.defineNonupdatableComponent("woodHealth", (s) => {
    return s;
});
...
const raiseDmgWood = eventWizard("dmg-wood", [[WoodHealthDef]], ([wood], hits) => {
...
EM.addEagerInit([WoodStateDef], [], [], () => {
    EM.addSystem("runWooden", Phase.GAME_WORLD, [WoodStateDef, WoodHealthDef, WorldFrameDef, RenderableDef], [PhysicsResultsDef, RendererDef], (es, res) => {
        ...
        for (let w of es) {
            ...
            if (hits) {
                let boardSegHits = []; // TODO(@darzu): PERF. reuse for better memory?
                const balls = hits
    ...
    EM.addSystem("woodHealth", Phase.GAME_WORLD, [WoodStateDef, WorldFrameDef, WoodHealthDef, RenderableDef, ColorDef], [RendererDef, SplinterPoolsDef], async (es, res) => {
