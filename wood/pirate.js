...
import { cloneMesh, transformMesh, getAABBFromMesh, } from "../meshes/mesh.js";
...
export const PiratePlatformDef = EM.defineNonupdatableComponent("piratePlatform", (cannon, timber) => {
    return {
...
export async function startPirates() {
    ...
    EM.addSystem("spawnPirates", Phase.GAME_WORLD, [PiratePlatformDef], [TimeDef], (ps, res) => {
    ...
    EM.addSystem("updatePiratePlatforms", Phase.GAME_WORLD, [PiratePlatformDef, PositionDef, RotationDef], [TimeDef], (ps, res) => {
        ...
        for (let p of ps) {
            ...
            if (doFire) {
                ...
                if (WorldFrameDef.isOn(c)) {
                    ...
                    fireBullet(2, c.world.position, c.world.rotation, 0.05, 0.02, 3 * 0.00001, ballHealth, [0, 0, -1]);
                }
            }
        }
    });
