...
import { IDENTITY_FRAME, PhysicsParentDef, PositionDef, TransformDef, createFrame, } from "./transform.js";
import { idPair } from "../utils/util.js";
...
export function registerUpdateWorldAABBs(s = "") {
    EM.addSystem("updateWorldAABBs", Phase.PHYSICS_WORLD_FROM_LOCAL, [PhysicsStateDef, WorldFrameDef, TransformDef], [], (objs, res) => {
        for (let o of objs) {
...
export const PhysicsBroadCollidersDef = EM.defineResource("_physBColliders", () => {
    return {
...
export function registerPhysicsStateInit() {
    ...
    EM.addSystem("physicsInit", Phase.PRE_PHYSICS, [ColliderDef, PositionDef], [PhysicsBroadCollidersDef], (objs, { _physBColliders }) => {
        for (let o of objs) {
            if (PhysicsStateDef.isOn(o)) {
...
export function registerUpdateInContactSystems() {
    EM.addSystem("updatePhysInContact", Phase.PHYSICS_CONTACT, [ColliderDef, PhysicsStateDef, WorldFrameDef], [PhysicsBroadCollidersDef, PhysicsResultsDef], (objs, res) => {
        // build a dict
...
export function registerPhysicsContactSystems() {
    ...
    EM.addSystem("physicsStepContact", Phase.PHYSICS_CONTACT, [ColliderDef, PhysicsStateDef, PositionDef, WorldFrameDef], [PhysicsBroadCollidersDef, PhysicsResultsDef], (objs, res) => {
        // build a dict
        // TODO(@darzu): would be nice if the query could provide this
        _objDict.clear();
        for (let o of objs)
