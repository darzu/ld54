...
EM.addSystem("landShipCollision", Phase.GAME_WORLD, [ShipDef, PositionDef, WorldFrameDef, PhysicsStateDef, LinearVelocityDef], [PartyDef, LandDef, LevelMapDef], (es, res) => {
    if (!es.length)
        return;
    const ship = es[0];
...
//# sourceMappingURL=land-collision.js.map