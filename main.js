...
import { ENABLE_NET, VERBOSE_LOG, VERBOSE_NET_LOG, } from "./flags.js";
...
async function startGame(localPeerName, host) {
    ...
    addEventComponents();
    if (GAME === "gjk")
        initGJKSandbox(hosting);
    else if (GAME === "rebound")
        initReboundSandbox(hosting);
    else if (GAME === "cloth")
        initClothSandbox(hosting);
    else if (GAME === "hyperspace")
        initHyperspaceGame();
    else if (GAME === "cube")
        initCubeGame();
    else if (GAME === "shipyard")
        initShipyardGame(hosting);
    else if (GAME === "font")
        initFontEditor();
    else if (GAME === "grass")
        initGrassGame(hosting);
    else if (GAME === "ld53")
        initLD53(hosting);
    else if (GAME === "ld54")
        initLD54();
