...
import { CameraFollowDef, CAMERA_OFFSETS, } from "../camera/camera.js";
...
export const raiseUnmanTurret = eventWizard("unman-turret", () => [[CanManDef], [TurretDef, CameraFollowDef]], ([player, turret]) => {
...
EM.addEagerInit([TurretDef], [], [], () => {
    EM.addSystem("turretYawPitch", Phase.GAME_PLAYERS, [TurretDef, RotationDef, YawPitchDef], [], (turrets, res) => {
    ...
    EM.addSystem("turretAim", Phase.GAME_PLAYERS, [TurretDef, YawPitchDef, CameraFollowDef], [InputsDef, LocalPlayerEntityDef], (turrets, res) => {
    ...
    EM.addSystem("turretManUnman", Phase.GAME_PLAYERS, [TurretDef, InRangeDef, AuthorityDef, CameraFollowDef], [InputsDef, LocalPlayerEntityDef, TextDef], (turrets, res) => {
