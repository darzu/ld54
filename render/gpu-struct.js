...
function wgslTypeToDummyVal(wgsl) {
    ...
    function _wgslTypeToDummyVal(wgsl) {
        ...
        if (wgsl === "vec4<f32>")
            return randVec4();
        if (wgsl === "vec4<u32>")
            return vec4.fromValues(Math.floor(Math.random() * Number.MAX_SAFE_INTEGER), Math.floor(Math.random() * Number.MAX_SAFE_INTEGER), Math.floor(Math.random() * Number.MAX_SAFE_INTEGER), Math.floor(Math.random() * Number.MAX_SAFE_INTEGER));
        if (wgsl === "u32")
