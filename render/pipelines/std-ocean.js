...
import { vec2, vec3, mat4, V } from "../../matrix/sprig-matrix.js";
...
export const RenderDataOceanDef = EM.defineNonupdatableComponent("renderDataOcean", (r) => r);
...
EM.addEagerInit([RenderDataOceanDef], [], [], () => {
    EM.addSystem("updateOceanRenderData", Phase.RENDER_PRE_DRAW, [RenderableDef, RenderDataOceanDef, RendererWorldFrameDef], [RendererDef], (objs, res) => {
