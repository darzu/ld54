...
import { getBoardsFromMesh, unshareProvokingForWood, WoodAssetsDef, } from "../wood/wood.js";
import { scaleMesh, transformMesh, getMeshAsGrid, mapMeshPositions, scaleMesh3, } from "./mesh.js";
import { XY } from "./mesh-loader.js";
import { mkCubeMesh, SHIP_OFFSET, makePlaneMesh, TETRA_MESH, mkOctogonMesh, mkHalfEdgeQuadMesh, HEX_MESH, RAFT_MESH, BULLET_MESH, GRID_PLANE_MESH, DBG_FABRIC, TRI_FENCE, makeSailMesh, mkTimberSplinterEnd, createRudderMesh, } from "./primatives.js";
...
export const ShipSmallMesh = XY.registerMesh({
    ...
    transform: mat4.fromRotationTranslationScaleOrigin(quat.IDENTITY, [0, 0, 0], [6, 6, 6], [0, 0, 0], mat4.create()),
});
...
export const CannonLD51Mesh = XY.registerMesh({
    ...
    transform: mat4.fromRotationTranslationScale(quat.rotateX(quat.IDENTITY, Math.PI * -0.5, quat.create()), [0, 0, 0], 
...
export const RudderMesh = XY.registerMesh({
    ...
    transform: mat4.translate(mat4.fromYRotation(-Math.PI * 0.5, mat4.create()), V(-5, 0, 0), mat4.create()),
});
...
export const WireCubeMesh = XY.registerMesh({
    name: "wireCube",
    data: () => ({ ...mkCubeMesh(), tri: [], colors: [], dbgName: "wireCube" }),
});
...
export const AllMeshesDef = XY.defineMeshSetResource("allMeshes", ...allMeshesList);
//# sourceMappingURL=mesh-list.js.map