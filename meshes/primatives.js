...
import { mapMeshPositions, scaleMesh, scaleMesh3, transformMesh, } from "./mesh.js";
import { mat4, quat, V, vec2, vec3, vec4, } from "../matrix/sprig-matrix.js";
...
export function makeSphere(numLon, numLat, r) {
    assert(numLon % 1 === 0 && numLon > 0);
    assert(numLat % 1 === 0 && numLat > 0);
    const uvs = [];
    const pos = [];
