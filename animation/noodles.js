...
import { mapMeshPositions, normalizeMesh, scaleMesh3, } from "../meshes/mesh.js";
...
export const NoodleDef = EM.defineNonupdatableComponent("noodle", (segments) => ({
    segments,
}));
...
export function registerNoodleSystem() {
    ...
    EM.addSystem("updateNoodles", Phase.GAME_WORLD, [NoodleDef, RenderableDef], [RendererDef], (es, rs) => {
        for (let e of es) {
