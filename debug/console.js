...
export function initDevConsole() {
    ...
    EM.addSystem("devConsoleToggle", Phase.GAME_PLAYERS, null, [InputsDef, DevConsoleDef], (_, res) => {
    ...
    EM.addSystem("devConsole", Phase.RENDER_DRAW, null, [RendererDef, TextDef, DevConsoleDef], async (_, res) => {
        frameCount++;
        if (PERF_DBG_GPU) {
